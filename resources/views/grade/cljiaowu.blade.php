          ...
          <div class="table-responsive"> 
           <table id="sample-table-1" class="table table-striped table-bordered table-hover">
               <tr  class="tree-folder-header">
                   <td class="center" style="width: 50%;">昨日成材率 </td>
                       ...
                       @foreach($val['xi'] as $k2=>$val2)
                           ...
                           @foreach($val2['class'] as $k3=>$val3)
                               <tr  class="class_{{$val2['ser_id']}}" style="display: none;" onclick="student({{$val3['class_id']}})">
                                   ...
                                   <td class="center">昨天成材率 {{$val3['theory']}} %</td>
                               </tr>
                               @if($k3==1)
                               <tr style="width:100%;display: none;" >
                                   <td class="center" rowspan="2">sadafsdwasdzx</td>
                               </tr>
                                @endif
                           @endforeach
                       @endforeach
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                $.each(obj, function (n,value) {
                    str+="<tr class='stu_"+a+"'>";
                    str+="<td class='center'>"+value['student_name']+"</td>";
                    str+="<td class='center'>技能&nbsp;&nbsp;"+value['theory']+"理论 &nbsp;&nbsp;"+value['theory']+"</td>";
                    str+="</tr>";
                })
//                alert(str)
                if( str != ""){
