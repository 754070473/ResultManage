...
<![endif]-->
		...
		<script type="text/javascript">
            ...
            function check_name(){
                ...
                if(theory==''){
                    document.getElementById('s_num').innerHTML="理论成绩不能为空";
                    return false;
                }else{
                    document.getElementById('s_num').innerHTML="<font color='#8fbc8f '></font>";
                    return true;
                }
            }
            ...
            //判断技能成绩
            function check_exam(){
                var exam=document.getElementById('form-field-2').value;
                if(exam==''){
                    document.getElementById('s_exam').innerHTML="技能成绩不能为空";
                    return false;
                }else{
                    document.getElementById('s_exam').innerHTML="<font color='#8fbc8f'></font>";
                    return true;
                }
            }
            ...
            function check_status(){
                var status=document.getElementById('form-field-5').value;
                if(status==''){
                    document.getElementById('s_status').innerHTML="不能为空";
                    return false;
                }else{
                    document.getElementById('s_status').innerHTML="<font color='#8fbc8f'></font>";
                    return true;
                }
            }
            ...
            //判断类型
            function check_type(){
                var type=document.getElementById('form-field-6').value;
                if(type==''){
                    document.getElementById('s_type').innerHTML="不能为空";
                    return false;
                }else{
                    document.getElementById('s_type').innerHTML="<font color='#8fbc8f'></font>";
                    return true;
                }
            }

            function check_all(){
                if(check_name()&&check_exam()&&check_status()&&check_type()){
                    return true;
                }else{
                    return false;
                }
