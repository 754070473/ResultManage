					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" onsubmit='return fun()' action="{{url('upda')}}" method='post'>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="oldpwd" name="oldpwd" placeholder="输入旧密码" class="col-xs-10 col-sm-5" onblur="oldPwd()"/>
											<font id="soldPwd" color='red'></font>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="newpwd" name="newpwd" placeholder="输入新密码" class="col-xs-10 col-sm-5" onblur="newPwd()"/>
											<font id="snewPwd" color='red'></font>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="newpass" name="newpass" placeholder="再次确认新密码" class="col-xs-10 col-sm-5" onblur="newPass()"/>
											<font id="snewPass" color='red'></font>
										</div>
									</div>
