                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <span class="input-icon">
                            <select  id="groupid">
                                @foreach($arr as $key=>$val)
                                    <option value="{{$val->gr_id}}">第 {{$key+1}} 组</option>
                                @endforeach
                            </select>
                            <a class="btn btn-xs btn-info" id="addHtml">添加用户 <i class='icon-user'></i></a>
                        </span>
                            </div>
                        </div>
                        <div class='col-md-offset-3 col-md-9' >
                        ...
                        <br/>
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <span class="btn btn-info"  onclick="creatstudent()">
...
<script type="text/javascript">
    jQuery(function ($) {
        $('#addHtml').click(function () {
            ...
            " <i class='icon-user'></i> " +
            "<input type='text' name='studentname' class='studentname' />" +
            " <i class='icon-remove-sign' onclick='$(this).parent().remove()'></i>" +
            "<br></div>")
        })
    })
    function creatstudent(){
       var groupid = $('#groupid').val()
        var ace2 = $('.studentname');
        var len = ace2.length;
        if( len >0 ){
            ...
            $.ajax({
                type: 'post',
                url: 'studentAdd',
                data: 'name=' + log_id+"&groupid="+groupid,
                success: function (msg) {
                        if(msg ==0){

                        }else if(msg ==1){
                            $('.studentname').parent().parent()..html('创建成功');
                        }
                }
            });
        }
